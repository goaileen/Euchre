...
public:
  ...
  bool is_face() const;
// the right and left "bowers" (high trumps).
  //REQUIRES trump is a valid suit
  //EFFECTS Returns true if card is the Jack of the trump suit
    // jack of hearts was alices highest card, higher than ace of hearts bc it is right bower
  ...
  //EFFECTS Returns true if card is the Jack of the next suit
    // the left bower is the jack of the same color as the trump suit (diamonds and hearts are red)
    // jack of hearts would be the left bower if diamonds were trump so it counts as a diamond face card
    // The second-highest trump is the jack of the other suit of the same color called the "left bower." (Example: If diamonds are trumps, the right bower is J♦ and left bower is J♥.)
